...
//bot
global.NumberBot = '6283831786231' // nomor bot dan ini untuk pairing code
...
global.donate = {
  ...
  gopay: '083133318509',
  ovo: '083133318509',
  qrcode: 'https://telegra.ph/file/029d1ff023ef98244e3a7.jpg', // ganti jadi url image qris atau ganti url pp bot
  quote: 'Donasimu, semangat kami !' // ubah quote atau ubah jadi false / '' jika ingin kosong.
}

// sosial media
global.sosmed = {
  ig: 'https://www.instagram.com/ndyzz004', //instagram
...
global.mess = {
  ...
  premium: '_*❗Perintah Ini Hanya Bisa Digunakan Oleh User Premium !*_',
  ...
  register: '_*❗anda belum register, silahkan register dulu !*_.\ngender: w: women m: man\n*ex:* .daftar NdyZz.20.m',
}
